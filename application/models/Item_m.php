...
class item_m extends CI_Model {
     ...
     // start datatables
     var $column_order = array(null, 'barcode', 'p_item.nama', 'category_name', 'unit_name', 'price', 'stock'); //set column field database for datatable orderable
     ...
     private function _get_datatables_query() {
         $this->db->select('p_item.*, p_category.category_nama as category_name, p_unit.unit_nama as unit_name');
         $this->db->from('p_item');
